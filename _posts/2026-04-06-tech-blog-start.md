...
이 과정을 구현하면서 느낀 건, 렌더링 엔진을 만든다는 말이 결국 "그리기 전에 필요한 약속과 구조를 만드는 일"에 가깝다는 점이었다. Vulkan은 특히 그 성격이 더 강하다. 화면에 무언가가 보이기 전까지 준비해야 할 것이 많고, 그 준비가 조금만 엇나가도 결과가 전혀 안 보인다.
